...
public class AccountDao extends DAOImpl<AccountRecord, com.armin.revolut.models.tables.pojos.Account, Long> {
     ...
     */
    public List<com.armin.revolut.models.tables.pojos.Account> fetchRangeOfActive(Boolean lowerInclusive, Boolean upperInclusive) {
        return fetchRange(Account.ACCOUNT.ACTIVE, lowerInclusive, upperInclusive);
    }

    /**
     * Fetch records that have <code>ACTIVE IN (values)</code>
     */
    public List<com.armin.revolut.models.tables.pojos.Account> fetchByActive(Boolean... values) {
