...
public class AccountRecord extends UpdatableRecordImpl<AccountRecord> implements Record7<Long, String, Integer, BigDecimal, Boolean, LocalDateTime, LocalDateTime> {

    private static final long serialVersionUID = -817838144;
    ...
    @Override
    public Row7<Long, String, Integer, BigDecimal, Boolean, LocalDateTime, LocalDateTime> fieldsRow() {
        return (Row7) super.fieldsRow();
    }

    @Override
    public Row7<Long, String, Integer, BigDecimal, Boolean, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public AccountRecord values(Long value1, String value2, Integer value3, BigDecimal value4, Boolean value5, LocalDateTime value6, LocalDateTime value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountRecord(Long id, String code, Integer userId, BigDecimal balance, Boolean active, LocalDateTime createdOn, LocalDateTime updatedOn) {
        super(Account.ACCOUNT);
